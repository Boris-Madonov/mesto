...
let editProfileTextButton = content.querySelector('.profile-text__edit');
...
let profileName = content.querySelector('.profile-text__name');
let profileDescription = content.querySelector('.profile-text__description');
